...
| [@chialab/esbuild-plugin-node-resolve](./packages/esbuild-plugin-node-resolve) | An esbuild plugin that resolves and converts import statements using node resolution. | [<img src="https://img.shields.io/npm/v/@chialab/esbuild-plugin-node-resolve" alt="npm" />](https://www.npmjs.com/package/@chialab/esbuild-plugin-node-resolve) |
...
| [@chialab/estransform](./packages/node-resolve) | A promise based node resolution library based on enhanced-resolve. | [<img src="https://img.shields.io/npm/v/@chialab/node-resolve" alt="npm" />](https://www.npmjs.com/package/@chialab/node-resolve) |
