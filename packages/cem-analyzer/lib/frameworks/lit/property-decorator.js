    ...
    return {
        ...
        analyzePhase({ node, moduleDoc }) {
            ...
            node.body.body?.forEach((member) => {
                ...
                const propertyOptions = /** @type {CallExpression} */ (propertyDecorator.expression).arguments?.find(
                ...
                const reflectAtt = /** @type {ObjectProperty | undefined} */ (
                    propertyOptions?.find(
                        (prop) =>
                            prop.type === 'Property' &&
                            prop.key.type === 'Identifier' &&
                ...
                if (reflectAtt?.value.type === 'Literal' && reflectAtt.value.value === true) {
