 ...
 * @property {(filePath: string, decl: import('postcss').AtRule) => string|void} [transform] A transform function for the import.
 */
    ...
    const plugin = {
        ...
        AtRule: {
            async import(decl) {
                ...
                if (transform) {
                    resolvedImportPath = transform(resolvedImportPath, decl) || resolvedImportPath;
                }
